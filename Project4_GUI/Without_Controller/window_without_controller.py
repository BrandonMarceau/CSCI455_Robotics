...
class RobotForwardOrBack(Action):
    ...
    def run(self):
        if self.direction == 'f':
            ...
            pass#cntrl.forward(self.speed, self.time)
        else:
            pass#cntrl.backward(self.speed, self.time)
...
class HeadLeftOrRight(Action):
    ...
    def run(self):
        ...
        if self.direction=='l':
            pass#cntrl.headLeft(self.degrees)
        else:
            pass#cntrl.headRight(self.degrees)
...
class HeadUpOrDown(Action):
    ...
    def run(self):
        ...
        if self.direction=='u':
            pass#cntrl.headUp(self.degrees)
        else:
            pass#cntrl.headDown(self.degrees)
...
class WaistLeftOrRight(Action):
    ...
    def run(self):
        ...
        if self.direction=='l':
            pass#cntrl.waistLeft(self.deg)
        else:
            pass#cntrl.waistRight(self.deg)
...
class AnimeWindow():
    def __init__(self, win):
        self.win = win
        self.win.geometry("800x480")
        self.myCanvas = tk.Canvas(self.win, bg="light blue", width="800", height="480")
        self.render_y = 5
        
    def createAnimation(self):
        self.win.pack(expand=YES, fill=BOTH)
        gif1 = PhotoImage(file='animeEyes.gif')
        self.win.create_image(50, 10, image=gif1, anchor=NW)
        mainloop()
